...
class KotlinSourceParser:
    ...
    def _get_kotlin_file_metadata(self, file_path: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            package_name = ""
            found_types = [] # Stores simple names of top-level types
            ...
            for child in root.children:
                ...
                # 2. Find Top-Level Classes, Objects, and Interfaces
                elif child.type in ["class_declaration", "object_declaration", "interface_declaration"]:
                    name_node = child.child_by_field_name("name")
                    if name_node:
                        found_types.append(name_node.text.decode("utf-8"))
            ...
            if has_top_level_members:
                ...
                # Ensure 'Kt' is always capitalized correctly
            ...
            return {
                ...
                "fqns": fqns,
                "is_special_type": False # Kotlin doesn't have direct equivalents to package-info.java for this context
            }
